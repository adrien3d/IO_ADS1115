...
typedef enum
{
  ADS1115_GAIN_TWOTHIRDS    = ADS1115_REG_CONFIG_PGA_6_144V,
  ADS1115_GAIN_ONE          = ADS1115_REG_CONFIG_PGA_4_096V,
  ADS1115_GAIN_TWO          = ADS1115_REG_CONFIG_PGA_2_048V,
  ADS1115_GAIN_FOUR         = ADS1115_REG_CONFIG_PGA_1_024V,
  ADS1115_GAIN_EIGHT        = ADS1115_REG_CONFIG_PGA_0_512V,
  ADS1115_GAIN_SIXTEEN      = ADS1115_REG_CONFIG_PGA_0_256V
} ADS1115_adsGain_t;
...
protected:
   ...
   uint8_t   m_bitShift;
   ADS1115_adsGain_t m_gain;

 public:
  IO_ADS1115(uint8_t i2cAddress = ADS1115_ADDRESS);
  void begin(void);
  ...
  void      setGain(ADS1115_adsGain_t gain);
  ADS1115_adsGain_t getGain(void);
